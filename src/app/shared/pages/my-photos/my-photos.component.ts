...
export class MyPhotosComponent implements OnInit {
  ...
  private loadMyPhotos() {
    ...
    console.log('Chargement des vraies photos depuis l\'API...');
    this.photoApiService.getMyPhotos(1, 50, undefined, this.getSortBy(), this.getSortOrder())
      .subscribe({
        next: (response) => {
          ...
          if (response.events && response.events.length > 0) {
            ...
            console.log('Photos réelles chargées:', this.photosByEvent);
          } else {
            console.log('Aucune photo trouvée, utilisation des données mockées');
            this.loadMockData();
          }
