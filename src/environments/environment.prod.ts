export const environment = {
  production: true,
  apiUrl: 'https://event-photo-back-h3gqdbh8bvcrccae.westeurope-01.azurewebsites.net',
  ...
  websocketUrl: 'wss://event-photo-back-h3gqdbh8bvcrccae.westeurope-01.azurewebsites.net/hub',
  fileUpload: {
